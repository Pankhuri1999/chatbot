...
name = input("Namaste , what is your name? ")
...
time.sleep(2)
intro = input("Do you eant to start  with your IQ challenge ")
if "n" in intro.lower():
  print("Okay bro !")
  bye = input("bye then")
  ...
  ques1 = input("Does any two of the following numbers add up to seventeen - (6 , 13 , 2 , 12 , 7 , 14) ?")
  ...
  ques2 = input("Does \"racecar\" spell same backwards ?")
  ...
  ques3 = input("If u rearrange the word \"EOSSH \" , then you will get the name if a/an - ")
  if (ques3.lower()=="shoes"):
    score = score + 5
  else:
    pass
  
  ques4 = input("Ralph travels four blocks north and then three blocks east .How many blocks is Ralph from his starting place?")
